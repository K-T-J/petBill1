...
<% 
	...
	String revp = mr.getFilesystemName("reviewPhoto");
	System.out.println("사진 " + revp);
		...
		if(mr.getFilesystemName("reviewPhoto") != null){ //reviewPhoto에 담겨서 들어왔으면
			...
			article.setReviewPhoto(mr.getFilesystemName("reviewPhoto")); //reviewphoto dto에 담고 기존데이터 삭제
		}else{ //사진 업데이트 안할경우
			article.setReviewPhoto("none");
		}
