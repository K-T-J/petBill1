	...
	<table>
		<tr>
			<td>다른 전화번호를 입력해주세요.<br />
				...
				<input style="width: 105px;" class="back" type="submit" value="중복확인"/>
			</td>
		</tr>
	</table>
	</form>
...
<% 	}else {//전화번호 없음. 사용가능 처리 %>
		...
		<input class="back" type="button" value="닫기" onclick="setHosTel()" />
		</div>
<%	} %>
	...
	<script>
		function setHosTel(){
			...
			opener.document.hosInputForm.hosTelCheck.value="1";	
			self.close();
		}
	</script>
