...
%>
	  ...
	  <%}
		...
		hosDto.setHosBasicVaccin(mr.getParameter("hosBasicVaccin"));
		hosDto.setHosNeuteringMan(mr.getParameter("hosNeuteringMan"));
		hosDto.setHosNeuteringWoman(mr.getParameter("hosNeuteringWoman"));
		hosDto.setHosHeartWorm(mr.getParameter("hosHeartWorm"));
