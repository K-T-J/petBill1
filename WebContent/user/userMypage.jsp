		...
		<div style="height: 100%; width: 50%;">
			...
			<h1 style=" margin-left: 195px;">회원 정보</h1>
				<table style="margin-left: 195px;">
					...
					<tr>
						<td><br/>주소<br/>
								<%=dto.getUserSiAddress()%><br/>
								<%=dto.getUserSelectAddress() %><br/>
					...
					<tr>	
						<td><br/>
							<button onclick="window.location = 'userModifyForm.jsp'"><h1>수정하기</h1></button>
							<button onclick="window.location ='/petBill/search/main.jsp'"><h1>메인으로</h1></button>
						</td>
					</tr>
				</table>
			</div>
