...
<body>
	...
	<div style="height: 500px; display: flex; margin: 100px">	
		<div style="display: flex; align-items: center; flex-direction: row; justify-content: center; width: 940px;">
			<div>
				<button style="width: 400px; height: 400px;" onclick="window.location='/petBill/user/userSignupForm.jsp'"><h1>일반 회원 가입</h1></button>
			</div>
		</div>
		<div style="width: 940px; display: flex; align-items: center; flex-direction: row; justify-content: center;">
			<div>
				<button style="width: 400px; height: 400px;" onclick="window.location='/petBill/hospital/hosBeforeForm.jsp'"><h1>병원 회원 가입</h1></button>
			</div>
		</div>	
	</div>	
</body>
