	...
	<table>
		<tr>
			<td>다른 아이디를 적어주세요<br/>
				...
				<input style="width: 105px;" class="back" type="submit" value ="아이디 중복확인"/>
			</td>
		</tr>
	</table>
</form>	
	...
	<table>
			<tr>
				<td>입력하신 <%=userId %>는 사용가능한 아이디 입니다<br/>
					<input class="back" type="button" value = "닫기" onclick="setUserId()"/>
				</td>
			</tr>
	</table>
<%} %>
	<script>
		function setUserId(){//opener는 자신을 open시킨 홈페이지
			...
			opener.document.inputForm.userIdcheck.value="1";	
			self.close(); //팝업창 닫기
		}
	</script>
</body>
